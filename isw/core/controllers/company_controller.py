...
class CompanyController(Controller):
    ...
    def get_company_reports(self, **kwargs):
        command = GetCompanyReportsCommand(**kwargs)
        return self.executor.execute_read(command)
    
    def get_report_anomalies(self, **kwargs):
        command = GetReportAnomaliesCommand(**kwargs)
        return self.executor.execute_read(command)